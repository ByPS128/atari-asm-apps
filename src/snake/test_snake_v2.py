#!/usr/bin/env python3
"""Automaticky test snake_V2.xex v headless harnessu ../tetris/tools/emu.py.

Spusteni:  python test_snake_v2.py          (predpoklada prelozeny snake_V2.xex + snake_V2.lab)
Vystup:    out2_menu.png, out2_game.png, out2_over.png v tomto adresari.
"""
import os, sys
...
XEX = os.path.join(HERE, 'snake_V2.xex')
LAB = os.path.join(HERE, 'snake_V2.lab')
...
def main():
    ...
    m.screenshot(os.path.join(HERE, 'out2_menu.png'))
    ...
    m.screenshot(os.path.join(HERE, 'out2_u.png'))
    ...
    m.screenshot(os.path.join(HERE, 'out2_over.png'))
    m.tap(fire=True); m.run(3)
